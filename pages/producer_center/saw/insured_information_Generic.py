...
class Insured_Information_Generic():
    ...
    #
    #     # Insured_Information_Generic.PageElements(self).annual_revenue.send_keys(revenue)

    def click_next(self):
        Insured_Information_Generic.PageElements(self).next_button.click()

    def click_return_to_Admin_Interface(self):
        Insured_Information_Generic.PageElements(self).return_to_Admin.click()
