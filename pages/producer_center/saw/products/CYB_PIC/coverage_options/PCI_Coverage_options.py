...
class PCI_Coverage_Options():
    ...
    def select_1M_Medefense_Plus_Only_1MM_1MM_limit_0_Deduct(self):
        PCI_Coverage_Options.PageElements(self).option_820_limit_3137.click()
        PCI_Coverage_Options.PageElements(self).option_820_deductible_1278.click()

    def select_1M_Cyber_Liability_Only_1MM_1MM_limit_0_2pt5K_Deduct(self):
        PCI_Coverage_Options.PageElements(self).option_818_limit_3138.click()
        PCI_Coverage_Options.PageElements(self).option_818_deductible_1279.click()

    def select_2M_Cyber_Liability_Only_1MM_1MM_limit_0_2pt5K_Deduct(self):
        PCI_Coverage_Options.PageElements(self).option_824_limit_3142.click()
        PCI_Coverage_Options.PageElements(self).option_824_deductible_1279.click()

    def select_3M_Cyber_Liability_Only_1MM_1MM_limit_0_2pt5K_Deduct(self):
        PCI_Coverage_Options.PageElements(self).option_827_limit_3144.click()
        PCI_Coverage_Options.PageElements(self).option_827_deductible_1279.click()

    def select_1M_Cyber_Liability_and_Medefense_Plus_1MM_1MM_limit_0_0_2pt5K_Deduct(self):
        PCI_Coverage_Options.PageElements(self).option_819_limit_3139.click()
        PCI_Coverage_Options.PageElements(self).option_819_deductible_1280.click()

    def select_2M_Cyber_Liability_and_Medefense_Plus_1MM_1MM_limit_0_0_2pt5K_Deduct(self):
        PCI_Coverage_Options.PageElements(self).option_825_limit_3143.click()
        PCI_Coverage_Options.PageElements(self).option_825_deductible_1280.click()

    def select_3M_Cyber_Liability_and_Medefense_Plus_1MM_1MM_limit_0_0_2pt5K_Deduct(self):
        PCI_Coverage_Options.PageElements(self).option_828_limit_3145.click()
        PCI_Coverage_Options.PageElements(self).option_828_deductible_1280.click()

    def select_all_deselect_all(self):
        PCI_Coverage_Options.PageElements(self).select_deselect_all.click()

    def click_proceed_to_quote(self):
        PCI_Coverage_Options.PageElements(self).proceed_to_quote.click()

    def click_return_to_Admin_Interface(self):
        PCI_Coverage_Options.PageElements(self).return_to_admin_interface.click()