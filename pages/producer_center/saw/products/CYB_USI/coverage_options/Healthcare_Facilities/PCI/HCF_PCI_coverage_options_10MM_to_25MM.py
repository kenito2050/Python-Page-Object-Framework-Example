...
class HCF_PCI_Coverage_Options_10MM_to_25MM():
    ...
    def select_USI_PrivaSafe_MEDEFENSE_Plus_Only_1MM_1MM_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_538_limit_2384.click()
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_538_deductible_924.click()

    def select_USI_PrivaSafe_Only_1MM_1MM_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_539_limit_2386.click()
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_539_deductible_922.click()

    def select_USI_PrivaSafe_Higher_Limits_Only_2MM_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_881_limit_2409.click()
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_881_deductible_922.click()

    def select_USI_PrivaSafe_Higher_Limits_Only_3MM_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_881_limit_3237.click()
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_881_deductible_922.click()

    def select_USI_PrivaSafe_with_MEDEFENSE_Plus_Combined_1MM_1MM_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_540_limit_2387.click()
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_540_deductible_923.click()

    def select_USI_PrivaSafe_Higher_Limits_with_MEDEFENSE_Plus_Combined_2MM_1MM_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_882_limit_2418.click()
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_882_deductible_923.click()

    def select_USI_PrivaSafe_Higher_Limits_with_MEDEFENSE_Plus_Combined_3MM_1MM_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_882_limit_3239.click()
        HCF_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_882_deductible_923.click()
