...
class HCF_No_PCI_Coverage_Options_10MM_to_25MM():
    ...
    def select_USI_PrivaSafe_MEDEFENSE_Plus_Only_1MM_1MM_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_538_limit_2384.click()
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_538_deductible_924.click()

    def select_USI_PrivaSafe_Only_without_PCI_1MM_1MM_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_541_limit_2389.click()
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_541_deductible_927.click()

    def select_USI_PrivaSafe_Higher_Limits_Only_without_PCI_2MM_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_883_limit_2410.click()
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_883_deductible_927.click()

    def select_USI_PrivaSafe_Higher_Limits_Only_without_PCI_3MM_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_883_limit_3238.click()
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_883_deductible_927.click()

    def select_USI_PrivaSafe_with_MEDEFENSE_Plus_Combined_without_PCI_1MM_1MM_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_542_limit_2390.click()
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_542_deductible_928.click()

    def select_USI_PrivaSafe_Higher_Limits_with_MEDEFENSE_Plus_Combined_without_PCI_2MM_1MM_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_884_limit_2419.click()
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_884_deductible_928.click()

    def select_USI_PrivaSafe_Higher_Limits_with_MEDEFENSE_Plus_Combined_without_PCI_3MM_1MM_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_884_limit_3240.click()
        HCF_No_PCI_Coverage_Options_10MM_to_25MM.PageElements(self).option_884_deductible_928.click()