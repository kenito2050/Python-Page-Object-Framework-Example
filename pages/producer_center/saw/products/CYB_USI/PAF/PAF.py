...
class PAF():
    ...
    def Page_Elements(self):
        ...
        # Name of current medical professional liability carrier:

        self.liability_carrier = self.driver.find_element(By.ID, "cyb_usi_liability_carrier")
        ...
        # Do Your operations include alternative medicine, wellness treatment, acupuncture, anti-aging services, hormone modification, naturopathic services, pain management, or home health care or durable medical equipment distributing services

        self.practice_special_services_yes = self.driver.find_element(By.ID, "practice_special_services-yes")

        self.practice_special_services_no = self.driver.find_element(By.ID, "practice_special_services-no")

        # MEDEFENSE™ Plus Questions

        # Are You utilizing a current edition of the CPT manual to ensure billing compliance?

        self.utilize_cpt_manual_yes = self.driver.find_element(By.ID, "cyb_usi_utilize_cpt_manual-yes")

        self.utilize_cpt_manual_no = self.driver.find_element(By.ID, "cyb_usi_utilize_cpt_manual-no")
        ...
        self.billings_exceed_two_million_yes = self.driver.find_element(By.ID, "cyb_usi_billings_exceed_one_million-yes")

        self.billings_exceed_two_million_no = self.driver.find_element(By.ID, "cyb_usi_billings_exceed_one_million-no")
        ...
        self.audited_investigated_yes = self.driver.find_element(By.ID, "cyb_usi_audited_investigated-yes")

        self.audited_investigated_no = self.driver.find_element(By.ID, "cyb_usi_audited_investigated-no")
        ...
        self.audited_investigated_medicare_yes = self.driver.find_element(By.ID, "cyb_usi_audited_investigated_medicare-yes")

        self.audited_investigated_medicare_no = self.driver.find_element(By.ID, "cyb_usi_audited_investigated_medicare-no")

        # Have You or any physician in Your group ever had to refund amounts to Public and/or Private payers in excess of $10,000?

        self.refund_excess_10_thousand_yes = self.driver.find_element(By.ID, "cyb_usi_refund_excess_10_thousand-yes")

        self.refund_excess_10_thousand_no = self.driver.find_element(By.ID, "cyb_usi_refund_excess_10_thousand-no")

        # Have You or any physician in Your group ever been accused of billing errors by any government agency or commercial payer?

        self.accused_billing_errors_yes = self.driver.find_element(By.ID, "cyb_usi_accused_billing_errors-yes")

        self.accused_billing_errors_no = self.driver.find_element(By.ID, "cyb_usi_accused_billing_errors-no")

        # Have You or any physician in Your Group ever:

        # Been investigated or sanctioned by a state medical licensing board?

        self.investigated_sanctioned_yes = self.driver.find_element(By.ID, "cyb_usi_investigated_sanctioned-yes")

        self.investigated_sanctioned_no = self.driver.find_element(By.ID, "cyb_usi_investigated_sanctioned-no")

        # Been involved in Stark/anti-kickback investigation?

        self.anti_kickback_investigation_yes = self.driver.find_element(By.ID, "cyb_usi_anti_kickback_investigation-yes")

        self.anti_kickback_investigation_no = self.driver.find_element(By.ID, "cyb_usi_anti_kickback_investigation-no")

        # Been sued or deselected from a private commercial payer?

        self.sued_deselected_payer_yes = self.driver.find_element(By.ID, "cyb_usi_sued_deselected_payer-yes")

        self.sued_deselected_payer_no = self.driver.find_element(By.ID, "cyb_usi_sued_deselected_payer-no")

        # Been investigated for EMTALA violations?

        self.investigated_emtala_yes = self.driver.find_element(By.ID, "cyb_usi_investigated_emtala-yes")

        self.investigated_emtala_no = self.driver.find_element(By.ID, "cyb_usi_investigated_emtala-no")

        # Been investigated for HIPAA violations?

        self.investigated_hipaa_yes = self.driver.find_element(By.ID, "cyb_usi_investigated_hipaa-yes")

        self.investigated_hipaa_no = self.driver.find_element(By.ID, "cyb_usi_investigated_hipaa-no")

        # Voluntarily disclosed any billing errors or irregular billing practices?

        self.voluntary_disclosure_yes = self.driver.find_element(By.ID, "cyb_usi_voluntary_disclosure-yes")

        self.voluntary_disclosure_no = self.driver.find_element(By.ID, "cyb_usi_voluntary_disclosure-no")

        # Have You ever been non-renewed, placed on extension, or declined from similar regulatory/billing errors insurance?

        # self.non_renewed_extention_yes = self.driver.find_element(By.ID, "cyb_usi_non_renewed_extention-yes")
        #
        # self.non_renewed_extention_no = self.driver.find_element(By.ID, "cyb_usi_non_renewed_extention-no")
        ...
        self.regulatory_investigation_yes = self.driver.find_element(By.ID, "cyb_usi_regulatory_investigation-yes")

        self.regulatory_investigation_no = self.driver.find_element(By.ID, "cyb_usi_regulatory_investigation-no")

        # Include e-MD Liability coverage

        self.include_emd = self.driver.find_element(By.NAME, "cyb_usi_include_emd")

        # e-MD Questions

        # Does the applicant utilize a cloud provider to store data

        self.cloud_provider_yes = self.driver.find_element(By.ID, "cyb_usi_cloud_provider-yes")

        self.cloud_provider_no = self.driver.find_element(By.ID, "cyb_usi_cloud_provider-no")

        # Please name the cloud provider
        self.cloud_provider_detail = self.driver.find_element(By.ID, "cyb_usi_cloud_provider_detail")

        # Do You have a HIPAA compliance program in place?

        self.hipaa_compliance_program_yes = self.driver.find_element(By.ID, "cyb_usi_hipaa_compliance_program-yes")

        self.hipaa_compliance_program_no = self.driver.find_element(By.ID, "cyb_usi_hipaa_compliance_program-no")

        # Do You use anti-virus software and firewall protection on all desktops, portable devices and mission critical servers?

        self.platform_security_yes = self.driver.find_element(By.ID, "cyb_usi_platform_security-yes")

        self.platform_security_no = self.driver.find_element(By.ID, "cyb_usi_platform_security-no")
        ...
        # self.patient_information_yes = self.driver.find_element(By.ID, "cyb_usi_patient_information-yes")
        #
        # self.patient_information_no = self.driver.find_element(By.ID, "cyb_usi_patient_information-no")
        ...
        self.data_security_yes = self.driver.find_element(By.ID, "cyb_usi_data_security-yes")

        self.data_security_no = self.driver.find_element(By.ID, "cyb_usi_data_security-no")

        # DISPLAYS IF YES TO ABOVE QUESTION

        # Is such data encrypted to industry standards?

        self.data_security_encrypted_yes = self.driver.find_element(By.ID, "cyb_usi_data_security_encrypted-yes")

        self.data_security_encrypted_no = self.driver.find_element(By.ID, "cyb_usi_data_security_encrypted-no")

        # Does Your organization process, store, transmit or handle credit or debit card data?

        self.credit_card_data_yes = self.driver.find_element(By.ID, "cyb_usi_credit_card_data-yes")

        self.credit_card_data_no = self.driver.find_element(By.ID, "cyb_usi_credit_card_data-no")

        # DISPLAYS IF YES TO ABOVE QUESTION

        # Are Your data security controls compliant with the Payment Card Industry Data Security Standard (PCI DSS)?

        self.credit_card_data_compliant_yes = self.driver.find_element(By.ID, "cyb_usi_credit_card_data_compliant-yes")

        self.credit_card_data_compliant_no = self.driver.find_element(By.ID, "cyb_usi_credit_card_data_compliant-no")

        # Do Your wire transfer protocols prohibit one employee from controlling a transaction from beginning to end?

        #self.wire_transfer_protocols_yes = self.driver.find_element(By.ID, "cyb_usi_wire_transfer_protocols-yes")

        #self.wire_transfer_protocols_no = self.driver.find_element(By.ID, "cyb_usi_wire_transfer_protocols-no")

        # Does the number of records You store, either electronic or paper, exceed 20,000 records per physician?

        self.records_exceed_20000_yes = self.driver.find_element(By.ID, "cyb_usi_records_exceed_20000-yes")

        self.records_exceed_20000_no = self.driver.find_element(By.ID, "cyb_usi_records_exceed_20000-no")

        # total number of records

        self.records_exceed_20000_total = self.driver.find_element(By.ID, "cyb_usi_records_exceed_20000_total")
        ...
        #self.wire_transfer_loss_yes = self.driver.find_element(By.ID, "cyb_usi_wire_transfer_loss-yes")

        #self.wire_transfer_loss_no = self.driver.find_element(By.ID, "cyb_usi_wire_transfer_loss-no")
        ...
        self.cyber_complaints_litigation_yes = self.driver.find_element(By.ID, "cyb_usi_cyber_complaints_litigation-yes")

        self.cyber_complaints_litigation_no = self.driver.find_element(By.ID, "cyb_usi_cyber_complaints_litigation-no")
        ...
        self.aware_compromised_security_yes = self.driver.find_element(By.ID, "cyb_usi_aware_compromised_security-yes")

        self.aware_compromised_security_no = self.driver.find_element(By.ID, "cyb_usi_aware_compromised_security-no")

        # Have You ever been non-renewed, placed on extension, or declined for similar privacy/security liability coverage?

        # self.non_renewed_extention_cyb_yes = self.driver.find_element(By.ID, "cyb_usi_non_renewed_extention_cyb-yes")
        #
        # self.non_renewed_extention_cyb_no = self.driver.find_element(By.ID, "cyb_usi_non_renewed_extention_cyb-no")

        return self

    def create_quote_PCI_DSS_No_DQ_HealthCare_Facilities(self, revenue):
        ...
        PAF.Page_Elements(self).practice_special_services_no.click()
    ...
    def create_quote_No_PCI_DSS_No_DQ_HealthCare_Facilities(self, revenue):
    ...
    def create_quote_PCI_DSS_No_DQ_Not_HealthCare_Facilities(self, revenue):
