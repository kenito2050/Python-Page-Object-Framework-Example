...
class PAF():
    ...
    def Page_Elements(self):
        ...
        self.existing_insured_yes = self.driver.find_element(By.ID, "cyb_mmic_existing_insured-yes")

        self.existing_insured_no = self.driver.find_element(By.ID, "cyb_mmic_existing_insured-no")
        ...
        self.cyb_mmic_utilize_cpt_manual_yes = self.driver.find_element(By.ID, "cyb_mmic_utilize_cpt_manual-yes")

        self.cyb_mmic_utilize_cpt_manual_no = self.driver.find_element(By.ID, "cyb_mmic_utilize_cpt_manual-no")
        ...
        self.cyb_mmic_audited_investigated_yes = self.driver.find_element(By.ID, "cyb_mmic_audited_investigated-yes")

        self.cyb_mmic_audited_investigated_no = self.driver.find_element(By.ID, "cyb_mmic_audited_investigated-no")
        ...
        self.cyb_mmic_audited_investigated_medicare_yes = self.driver.find_element(By.ID, "cyb_mmic_audited_investigated_medicare-yes")

        self.cyb_mmic_audited_investigated_medicare_no = self.driver.find_element(By.ID, "cyb_mmic_audited_investigated_medicare-no")

        # Have You or any physician in Your group ever had to refund amounts to Public and/or Private payers in excess of $10,000?

        self.cyb_mmic_refund_excess_10_thousand_yes = self.driver.find_element(By.ID, "cyb_mmic_refund_excess_10_thousand-yes")

        self.cyb_mmic_refund_excess_10_thousand_no = self.driver.find_element(By.ID, "cyb_mmic_refund_excess_10_thousand-no")

        # Have You or any physician in Your group ever been accused of billing errors by any government agency or commercial payer?

        self.cyb_mmic_accused_billing_errors_yes = self.driver.find_element(By.ID, "cyb_mmic_accused_billing_errors-yes")

        self.cyb_mmic_accused_billing_errors_no = self.driver.find_element(By.ID, "cyb_mmic_accused_billing_errors-no")

        # Have You or any physician in Your Group ever:

        # Been investigated or sanctioned by a state medical licensing board?

        self.cyb_mmic_investigated_sanctioned_yes = self.driver.find_element(By.ID, "cyb_mmic_investigated_sanctioned-yes")

        self.cyb_mmic_investigated_sanctioned_no = self.driver.find_element(By.ID, "cyb_mmic_investigated_sanctioned-no")

        # Been involved in Stark/anti-kickback investigation?

        self.cyb_mmic_anti_kickback_investigation_yes = self.driver.find_element(By.ID, "cyb_mmic_anti_kickback_investigation-yes")

        self.cyb_mmic_anti_kickback_investigation_no = self.driver.find_element(By.ID, "cyb_mmic_anti_kickback_investigation-no")

        # Been sued or deselected from a private commercial payer?

        self.cyb_mmic_sued_deselected_payer_yes = self.driver.find_element(By.ID, "cyb_mmic_sued_deselected_payer-yes")

        self.cyb_mmic_sued_deselected_payer_no = self.driver.find_element(By.ID, "cyb_mmic_sued_deselected_payer-no")

        # Been investigated for EMTALA violations?

        self.cyb_mmic_investigated_emtala_yes = self.driver.find_element(By.ID, "cyb_mmic_investigated_emtala-yes")

        self.cyb_mmic_investigated_emtala_no = self.driver.find_element(By.ID, "cyb_mmic_investigated_emtala-no")

        # Been investigated for HIPAA violations?

        self.cyb_mmic_investigated_hipaa_yes = self.driver.find_element(By.ID, "cyb_mmic_investigated_hipaa-yes")

        self.cyb_mmic_investigated_hipaa_no = self.driver.find_element(By.ID, "cyb_mmic_investigated_hipaa-no")

        # Voluntarily disclosed any billing errors or irregular billing practices?

        self.cyb_mmic_voluntary_disclosure_yes = self.driver.find_element(By.ID, "cyb_mmic_voluntary_disclosure-yes")

        self.cyb_mmic_voluntary_disclosure_no = self.driver.find_element(By.ID, "cyb_mmic_voluntary_disclosure-no")

        # Have You ever been non-renewed, placed on extension, or declined from similar regulatory/billing errors insurance?

        self.cyb_mmic_non_renewed_extention_yes = self.driver.find_element(By.ID, "cyb_mmic_non_renewed_extention-yes")

        self.cyb_mmic_non_renewed_extention_no = self.driver.find_element(By.ID, "cyb_mmic_non_renewed_extention-no")
        ...
        self.cyb_mmic_regulatory_investigation_yes = self.driver.find_element(By.ID, "cyb_mmic_regulatory_investigation-yes")

        self.cyb_mmic_regulatory_investigation_no = self.driver.find_element(By.ID, "cyb_mmic_regulatory_investigation-no")

        # Include Cyber Liability coverage

        self.cyb_mmic_include_cyber = self.driver.find_element(By.NAME, "cyb_mmic_include_cyber")

        # Cyber Liability Questions

        # Do You have a HIPAA compliance program in place?

        self.cyb_mmic_hipaa_compliance_program_yes = self.driver.find_element(By.ID, "cyb_mmic_hipaa_compliance_program-yes")

        self.cyb_mmic_hipaa_compliance_program_no = self.driver.find_element(By.ID, "cyb_mmic_hipaa_compliance_program-no")

        # Do You use anti-virus software and firewall protection on all desktops, portable devices and mission critical servers?

        self.cyb_mmic_platform_security_yes = self.driver.find_element(By.ID, "cyb_mmic_platform_security-yes")

        self.cyb_mmic_platform_security_no = self.driver.find_element(By.ID, "cyb_mmic_platform_security-no")
        ...
        self.cyb_mmic_patient_information_yes = self.driver.find_element(By.ID, "cyb_mmic_patient_information-yes")

        self.cyb_mmic_patient_information_no = self.driver.find_element(By.ID, "cyb_mmic_patient_information-no")
        ...
        self.cyb_mmic_data_security_yes = self.driver.find_element(By.ID, "cyb_mmic_data_security-yes")

        self.cyb_mmic_data_security_no = self.driver.find_element(By.ID, "cyb_mmic_data_security-no")

        # DISPLAYS IF YES TO ABOVE QUESTION

        # Is such data encrypted to industry standards?

        self.cyb_mmic_data_security_encrypted_yes = self.driver.find_element(By.ID, "cyb_mmic_data_security_encrypted-yes")

        self.cyb_mmic_data_security_encrypted_no = self.driver.find_element(By.ID, "cyb_mmic_data_security_encrypted-no")

        # Does Your organization process, store, transmit or handle credit or debit card data?

        self.cyb_mmic_credit_card_data_yes = self.driver.find_element(By.ID, "cyb_mmic_credit_card_data-yes")

        self.cyb_mmic_credit_card_data_no = self.driver.find_element(By.ID, "cyb_mmic_credit_card_data-no")

        # DISPLAYS IF YES TO ABOVE QUESTION

        # Are Your data security controls compliant with the Payment Card Industry Data Security Standard (PCI DSS)?

        self.cyb_mmic_credit_card_data_compliant_yes = self.driver.find_element(By.ID, "cyb_mmic_credit_card_data_compliant-yes")

        self.cyb_mmic_credit_card_data_compliant_no = self.driver.find_element(By.ID, "cyb_mmic_credit_card_data_compliant-no")
        ...
        self.cyb_mmic_records_exceed_20000_yes = self.driver.find_element(By.ID, "cyb_mmic_records_exceed_20000-yes")

        self.cyb_mmic_records_exceed_20000_no = self.driver.find_element(By.ID, "cyb_mmic_records_exceed_20000-no")

        # total number of records

        self.cyb_mmic_records_exceed_20000_total = self.driver.find_element(By.ID, "cyb_mmic_records_exceed_20000_total")
        ...
        self.cyb_mmic_cyber_complaints_litigation_yes = self.driver.find_element(By.ID, "cyb_mmic_cyber_complaints_litigation-yes")

        self.cyb_mmic_cyber_complaints_litigation_no = self.driver.find_element(By.ID, "cyb_mmic_cyber_complaints_litigation-no")
        ...
        self.cyb_mmic_aware_compromised_security_yes = self.driver.find_element(By.ID, "cyb_mmic_aware_compromised_security-yes")

        self.cyb_mmic_aware_compromised_security_no = self.driver.find_element(By.ID, "cyb_mmic_aware_compromised_security-no")

        # Have You ever been non-renewed, placed on extension, or declined for similar privacy/security liability coverage?

        self.cyb_mmic_non_renewed_extention_cyb_yes = self.driver.find_element(By.ID, "cyb_mmic_non_renewed_extention_cyb-yes")

        self.cyb_mmic_non_renewed_extention_cyb_no = self.driver.find_element(By.ID, "cyb_mmic_non_renewed_extention_cyb-no")
    ...
    def create_quote_PCI_DSS_No_DQ(self, revenue):
        ...
        PAF.Page_Elements(self).cyb_mmic_audited_investigated_no.click()
