...
class No_PCI_Coverage_Options_After_Sep_6_2017():
    ...
    def select_1M_Medefense_Plus_Only_1MM_1MM_limit_0_Deduct(self):
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_820_limit_3137.click()
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_820_deductible_1278.click()

    def select_1M_Cyber_Liability_Only_1MM_1MM_limit_0_2pt5K_Deduct(self):
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_821_limit_3140.click()
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_821_deductible_1281.click()

    def select_2M_Cyber_Liability_Only_No_PCI_1MM_1MM_limit_0_2pt5K_Deduct(self):
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_830_limit_3146.click()
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_830_deductible_1281.click()

    def select_3M_Cyber_Liability_Only_No_PCI_1MM_1MM_limit_0_2pt5K_Deduct(self):
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_832_limit_3148.click()
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_832_deductible_1281.click()

    def select_1M_Cyber_Liability_and_Medefense_Plus_No_PCI_1MM_1MM_limit_0_0_2pt5K_Deduct(self):
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_822_limit_3141.click()
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_822_deductible_1282.click()

    def select_2M_Cyber_Liability_and_Medefense_Plus_No_PCI_1MM_1MM_limit_0_0_2pt5K_Deduct(self):
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_831_limit_3147.click()
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_831_deductible_1282.click()

    def select_3M_Cyber_Liability_and_Medefense_Plus_No_PCI_1MM_1MM_limit_0_0_2pt5K_Deduct(self):
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_833_limit_3149.click()
        No_PCI_Coverage_Options_After_Sep_6_2017.PageElements(self).option_833_deductible_1282.click()
