...
class No_PCI_Doctor_Count_5_Broad_Reg_Protect_Combined():
    ...
    def select_Broad_Regulatory_Protection_Plus_and_eMD_Combined_Only_No_PCI_500K_2_pt_5_MM_limit_0_Deduct(self):
        No_PCI_Doctor_Count_5_Broad_Reg_Protect_Combined.PageElements(self).option_851_limit_3178.click()
        No_PCI_Doctor_Count_5_Broad_Reg_Protect_Combined.PageElements(self).option_851_deductible_762.click()

    def select_Broad_Regulatory_Protection_Plus_and_eMD_Combined_Only_No_PCI_1MM_5MM_limit_0_Deduct(self):
        No_PCI_Doctor_Count_5_Broad_Reg_Protect_Combined.PageElements(self).option_851_limit_3173.click()
        No_PCI_Doctor_Count_5_Broad_Reg_Protect_Combined.PageElements(self).option_851_deductible_762.click()