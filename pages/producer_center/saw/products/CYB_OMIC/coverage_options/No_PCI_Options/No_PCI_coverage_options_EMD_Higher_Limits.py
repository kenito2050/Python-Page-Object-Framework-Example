...
class No_PCI_Coverage_Options_eMD_Higher_Limits():
    ...
    def PageElements(self):
        ...
        # 2MM/2MM
        self.option_857_limit_3197 = self.driver.find_element(By.ID, "option-857-limit-3197")
        ...
        # 3MM/3MM
        self.option_859_limit_3202 = self.driver.find_element(By.ID, "option-859-limit-3202")
    ...
    def select_2M_Broad_Regulatory_Protection_Plus_and_eMD_Combined_No_PCI_2MM_2MM_limit_0_Deduct(self):
        No_PCI_Coverage_Options_eMD_Higher_Limits.PageElements(self).option_857_limit_3197.click()
    ...
    def select_3M_Broad_Regulatory_Protection_Plus_and_eMD_Combined_No_PCI_3MM_3MM_limit_0_Deduct(self):
        No_PCI_Coverage_Options_eMD_Higher_Limits.PageElements(self).option_859_limit_3202.click()
