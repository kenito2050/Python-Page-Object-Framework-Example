...
class PAF():
    ...
    def Page_Elements(self):
        ...
        self.total_records = self.driver.find_element(By.ID, "ngp_usi_total_records")

        # Does the Applicant use anti-virus software and a securely configured firewall to protect their network?
        self.platform_security_yes = self.driver.find_element(By.ID, "ngp_usi_platform_security-yes")

        self.platform_security_no = self.driver.find_element(By.ID, "ngp_usi_platform_security-no")
        ...
        self.data_storage_yes = self.driver.find_element(By.ID, "ngp_usi_data_storage-yes")

        self.data_storage_no = self.driver.find_element(By.ID, "ngp_usi_data_storage-no")

        # If "Yes", is such data encrypted to industry standards

        self.data_security_standards_yes = self.driver.find_element(By.ID, "ngp_usi_data_security_standards-yes")

        self.data_security_standards_no = self.driver.find_element(By.ID, "ngp_usi_data_security_standards-no")

        # Does the applicant utilize a cloud provider to store data

        self.cloud_provider_yes = self.driver.find_element(By.ID, "ngp_usi_cloud_provider-yes")

        self.cloud_provider_no = self.driver.find_element(By.ID, "ngp_usi_cloud_provider-no")

        # Please name the cloud provider
        self.cloud_provider_detail = self.driver.find_element(By.ID, "ngp_usi_cloud_provider_detail")

        # Are you PCI-DSS Compliant
        self.pci_dss_compliant_yes = self.driver.find_element(By.ID, "ngp_usi_pci_dss_compliant-yes")

        self.pci_dss_compliant_no = self.driver.find_element(By.ID, "ngp_usi_pci_dss_compliant-no")

        # pci_dss_compliant_na = self.driver.find_element(By.ID, "ngp_usi_pci_dss_compliant-na")
        ...
        self.complaints_litigation_yes = self.driver.find_element(By.ID, "ngp_usi_complaints_litigation-yes")

        self.complaints_litigation_no = self.driver.find_element(By.ID, "ngp_usi_complaints_litigation-no")
        ...
        self.regulatory_investigation_yes = self.driver.find_element(By.ID, "ngp_usi_regulatory_investigation-yes")

        self.regulatory_investigation_no = self.driver.find_element(By.ID, "ngp_usi_regulatory_investigation-no")
