...
class Coverage_Options_Renewal():
    ...
    def select_all_deselect_all(self):
        Coverage_Options_Renewal.PageElements(self).select_deselect_all.click()

    def click_proceed_to_quote(self):
        Coverage_Options_Renewal.PageElements(self).proceed_to_quote.click()

    def click_return_to_Admin_Interface(self):
        Coverage_Options_Renewal.PageElements(self).return_to_admin_interface.click()