...
class HCF_No_PCI_Coverage_Options_25MM_or_Greater():
    ...
    def select_MEDEFENSE_Plus_Only_1MM_1MM_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_799_limit_160.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_799_deductible_146.click()

    def select_MEDEFENSE_Plus_Only_1MM_1MM_limit_10K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_799_limit_160.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_799_deductible_147.click()

    # def select_eMD_Only_Without_PCI_and_Cyber_Crime_1MM_1MM_100K_limit_2pt5K_Deduct(self):
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_801_limit_3107.click()
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_801_deductible_1254.click()

    def select_eMD_Only_Without_PCI_and_Cyber_Crime_1MM_1MM_100K_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_801_limit_3107.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_801_deductible_1255.click()

    def select_eMD_Only_Without_PCI_and_Cyber_Crime_1MM_1MM_100K_limit_10K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_801_limit_3107.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_801_deductible_1256.click()

    # def select_eMD_Higher_Limits_Only_Without_PCI_and_Cyber_Crime_2MM_2MM_100K_250K_limit_2pt5K_Deduct(self):
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_804_limit_3110.click()
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_804_deductible_1254.click()

    def select_eMD_Higher_Limits_Only_Without_PCI_and_Cyber_Crime_2MM_2MM_100K_250K_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_804_limit_3110.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_804_deductible_1255.click()

    def select_eMD_Higher_Limits_Only_Without_PCI_and_Cyber_Crime_2MM_2MM_100K_250K_limit_10K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_804_limit_3110.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_804_deductible_1256.click()

    # def select_eMD_Higher_Limits_Only_Without_PCI_and_Cyber_Crime_3MM_3MM_100K_250K_limit_2pt5K_Deduct(self):
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_804_limit_3111.click()
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_804_deductible_1254.click()

    def select_eMD_Higher_Limits_Only_Without_PCI_and_Cyber_Crime_3MM_3MM_100K_250K_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_804_limit_3111.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_804_deductible_1255.click()
    ...
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_807_limit_3117.click()
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_807_deductible_1264.click()

    def select_MEDEFENSE_Plus_and_eMD_Without_PCI_and_Cyber_Crime_Combined_1MM_1MM_100K_250K_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_807_limit_3117.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_807_deductible_1265.click()

    def select_MEDEFENSE_Plus_and_eMD_Without_PCI_and_Cyber_Crime_Combined_1MM_1MM_100K_250K_limit_10K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_807_limit_3117.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_807_deductible_1263.click()
    ...
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_810_limit_3124.click()
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_810_deductible_1264.click()
    ...
    def select_Medefense_Plus_and_eMD_Higher_Limits_Without_PCI_and_Cyber_Crime_Combined_2MM_2MM_100K_250K_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_810_limit_3124.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_810_deductible_1265.click()
    ...
    def select_Medefense_Plus_and_eMD_Higher_Limits_Without_PCI_and_Cyber_Crime_Combined_2MM_2MM_100K_250K_limit_10K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_810_limit_3124.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_810_deductible_1263.click()
    ...
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_810_limit_3125.click()
    #     Coverage_Options_25MM_or_Greater.PageElements(self).option_810_deductible_1264.click()
    ...
    def select_Medefense_Plus_and_eMD_Higher_Limits_Without_PCI_and_Cyber_Crime_Combined_3MM_3MM_100K_250K_limit_5K_Deduct(self):
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_810_limit_3125.click()
        HCF_No_PCI_Coverage_Options_25MM_or_Greater.PageElements(self).option_810_deductible_1265.click()
