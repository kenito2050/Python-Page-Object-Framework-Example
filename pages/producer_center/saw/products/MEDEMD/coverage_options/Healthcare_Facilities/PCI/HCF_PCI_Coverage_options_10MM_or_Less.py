...
class HCF_PCI_Coverage_Options_10MM_or_Less():
    ...
    def select_MEDEFENSE_Plus_Only_1MM_1MM_limit_2pt5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_799_limit_160.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_799_deductible_145.click()

    def select_MEDEFENSE_Plus_Only_1MM_1MM_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_799_limit_160.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_799_deductible_146.click()

    def select_eMD_Only_With_PCI_and_Cyber_Crime_1MM_1MM_100K_limit_2pt5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_800_limit_3106.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_800_deductible_1250.click()

    def select_eMD_Only_With_PCI_and_Cyber_Crime_1MM_1MM_100K_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_800_limit_3106.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_800_deductible_1251.click()

    def select_eMD_Higher_Limits_Only_With_PCI_and_Cyber_Crime_2MM_2MM_100K_250K_limit_2pt5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_803_limit_3108.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_803_deductible_1250.click()

    def select_eMD_Higher_Limits_Only_With_PCI_and_Cyber_Crime_2MM_2MM_100K_250K_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_803_limit_3108.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_803_deductible_1251.click()

    def select_eMD_Higher_Limits_Only_With_PCI_and_Cyber_Crime_3MM_3MM_100K_250K_limit_2pt5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_803_limit_3109.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_803_deductible_1250.click()
    ...
    def select_MEDEFENSE_Plus_and_eMD_With_PCI_and_Cyber_Crime_Combined_1MM_1MM_100K_250K_limit_2pt5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_806_limit_3112.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_806_deductible_1260.click()

    def select_MEDEFENSE_Plus_and_eMD_With_PCI_and_Cyber_Crime_Combined_1MM_1MM_100K_250K_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_806_limit_3112.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_806_deductible_1261.click()
    ...
    def select_Medefense_Plus_and_eMD_Higher_Limits_With_PCI_and_Cyber_Crime_Combined_2MM_2MM_100K_250K_limit_2pt5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_809_limit_3122.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_809_deductible_1260.click()

    def select_Medefense_Plus_and_eMD_Higher_Limits_With_PCI_and_Cyber_Crime_Combined_2MM_2MM_100K_250K_limit_5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_809_limit_3122.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_809_deductible_1261.click()
    ...
    def select_Medefense_Plus_and_eMD_Higher_Limits_With_PCI_and_Cyber_Crime_Combined_3MM_3MM_100K_250K_limit_2pt5K_Deduct(self):
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_809_limit_3123.click()
        HCF_PCI_Coverage_Options_10MM_or_Less.PageElements(self).option_809_deductible_1260.click()
