...
class HNOA_Coverage_Options():
    ...
    def select_LTC_Include_HNOA_50K_200K_Limit(self):
        HNOA_Coverage_Options.PageElements(self).option_902_limit_722.click()
        HNOA_Coverage_Options.PageElements(self).option_902_deductible_49.click()
        HNOA_Coverage_Options.PageElements(self).ltc_hnoa_endt_selected.click()

    def select_LTC_Include_HNOA_100K_300K_Limit(self):
        HNOA_Coverage_Options.PageElements(self).option_902_limit_740.click()
        HNOA_Coverage_Options.PageElements(self).option_902_deductible_49.click()
        HNOA_Coverage_Options.PageElements(self).ltc_hnoa_endt_selected.click()

    def select_LTC_Include_HNOA_250K_500K_Limit(self):
        HNOA_Coverage_Options.PageElements(self).option_902_limit_227.click()
        HNOA_Coverage_Options.PageElements(self).option_902_deductible_49.click()
        HNOA_Coverage_Options.PageElements(self).ltc_hnoa_endt_selected.click()

    def select_LTC_Include_HNOA_500K_1MM_Limit(self):
        HNOA_Coverage_Options.PageElements(self).option_902_limit_226.click()
        HNOA_Coverage_Options.PageElements(self).option_902_deductible_49.click()
        HNOA_Coverage_Options.PageElements(self).ltc_hnoa_endt_selected.click()

    def select_LTC_Include_HNOA_1MM_1MM_Limit(self):
        HNOA_Coverage_Options.PageElements(self).option_902_limit_178.click()
        HNOA_Coverage_Options.PageElements(self).option_902_deductible_49.click()
        HNOA_Coverage_Options.PageElements(self).ltc_hnoa_endt_selected.click()

    def select_LTC_Include_HNOA_1MM_2MM_Limit(self):
        HNOA_Coverage_Options.PageElements(self).option_902_limit_179.click()
        HNOA_Coverage_Options.PageElements(self).option_902_deductible_49.click()
        HNOA_Coverage_Options.PageElements(self).ltc_hnoa_endt_selected.click()

    def select_LTC_Include_HNOA_1MM_3MM_Limit(self):
        HNOA_Coverage_Options.PageElements(self).option_902_limit_180.click()
        HNOA_Coverage_Options.PageElements(self).option_902_deductible_49.click()
        HNOA_Coverage_Options.PageElements(self).ltc_hnoa_endt_selected.click()
