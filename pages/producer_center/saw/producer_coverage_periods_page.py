...
class Producer_CoveragePeriods():
    ...
    def enter_current_date_as_effective_date(self, date_today):
        ...
        Producer_CoveragePeriods.PageElements(self).date_effective_start.click()
        Producer_CoveragePeriods.PageElements(self).date_effective_start.clear()
        Producer_CoveragePeriods.PageElements(self).date_effective_start.send_keys(date_today)
    ...
    def enter_ad_hoc_effective_date(self, ad_hoc_effectiveDate):
        ...
        Producer_CoveragePeriods.PageElements(self).date_effective_start.click()
        Producer_CoveragePeriods.PageElements(self).date_effective_start.clear()
        Producer_CoveragePeriods.PageElements(self).date_effective_start.send_keys(ad_hoc_effectiveDate)
