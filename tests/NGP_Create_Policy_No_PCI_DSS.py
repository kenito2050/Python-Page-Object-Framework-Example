...
class CreateQuote(unittest.TestCase):
    ...
    def login_search_for_agent_create_quote(self):
        ...
        company_name_string = company_name + " " + "-" + " " + state + " " + "NGP NO PCI DSS Test"
        ...
        saw_ii.click_next()
        saw_PAF = PAF(driver)
        saw_PAF.create_quote_NO_PCI_DSS()
        saw_PAF.click_next()
        saw_CC = Coverage_Options(driver)
        saw_CC.select_no_PCI_DSS_limits_deductibles_on_coverage_options()
