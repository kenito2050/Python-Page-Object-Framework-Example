...
from pages.producer_center.saw.products.NGP_SBDIA.PAF.PAF import PAF

### Generic Coverage Options Classes
from pages.producer_center.saw.products.NGP_SBDIA.coverage_options.coverage_options import Coverage_Options

### PCI Coverage Options Classes
from pages.producer_center.saw.products.NGP_SBDIA.coverage_options.PCI_Options.PCI_coverage_options import PCI_Coverage_Options

### Non PCI Coverage Options Classes
from pages.producer_center.saw.products.NGP_SBDIA.coverage_options.No_PCI_Options.No_PCI_coverage_options import No_PCI_Coverage_Options

from pages.producer_center.saw.products.NGP_SBDIA.insured_information.insured_information import Insured_Information
from pages.producer_center.saw.products.NGP_SBDIA.select_option.select_option import Select_Option
...
class CreateQuote():
    ...
    def test_login_search_for_agent_create_quote(self):
        ...
        for x in range(1, sh.nrows):
            ...
            saw_ii.enter_staff_count(staff_count)
            saw_ii.click_next()
            ...
            # Scenarios 1 - 5:  PCI Options
            # Scenarios 6 - 10: No PCI Options

            if test_scenario_number == "1":
                saw_PAF.create_quote_PCI_DSS_No_DQ_corporation(revenue)
            elif test_scenario_number == "2":
                saw_PAF.create_quote_PCI_DSS_No_DQ_partnership(revenue)
            elif test_scenario_number == "3":
                saw_PAF.create_quote_PCI_DSS_No_DQ_llc(revenue)
            elif test_scenario_number == "4":
                saw_PAF.create_quote_PCI_DSS_No_DQ_individual(revenue)
            elif test_scenario_number == "5":
                saw_PAF.create_quote_PCI_DSS_No_DQ_other(revenue)
            elif test_scenario_number == "6":
                saw_PAF.create_quote_No_PCI_DSS_No_DQ_corporation(revenue)
            elif test_scenario_number == "7":
                saw_PAF.create_quote_No_PCI_DSS_No_DQ_partnership(revenue)
            elif test_scenario_number == "8":
                saw_PAF.create_quote_No_PCI_DSS_No_DQ_llc(revenue)
            elif test_scenario_number == "9":
                saw_PAF.create_quote_No_PCI_DSS_No_DQ_individual(revenue)
            elif test_scenario_number == "10":
                saw_PAF.create_quote_No_PCI_DSS_No_DQ_other(revenue)
            ...
            ### PCI Scenarios
            # if test_scenario_number == "1" or test_scenario_number == "2" or test_scenario_number == "3" or test_scenario_number == "4" or test_scenario_number == "5":
            #     saw_CC_in_use = PCI_Coverage_Options(driver)
            #     getattr(saw_CC_in_use, _OLD_scenario)()
            #
            # ### Non-PCI Scenarios
            # elif test_scenario_number == "6" or test_scenario_number == "7" or test_scenario_number == "8" or test_scenario_number == "9" or test_scenario_number == "10":
