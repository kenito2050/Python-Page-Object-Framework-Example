...
class CreateQuote():
    ...
    def test_login_search_for_agent_create_quote(self):
        ...
        if test_scenario == "1":
            saw_PAF.create_quote_No_DQ_expert_witness(revenue_next_year, revenue_current_year, revenue_previous_year)
        elif test_scenario == "2":
            saw_PAF.create_quote_No_DQ_disability_evaluation(revenue_next_year, revenue_current_year, revenue_previous_year)
        elif test_scenario == "3":
            saw_PAF.create_quote_No_DQ_managed_care_contracting(revenue_next_year, revenue_current_year, revenue_previous_year)
        elif test_scenario == "4":
            saw_PAF.create_quote_No_DQ_independent_medical_review(revenue_next_year, revenue_current_year, revenue_previous_year)
        elif test_scenario == "5":
            saw_PAF.create_quote_No_DQ_workers_compensation_evaluation(revenue_next_year, revenue_current_year, revenue_previous_year)
