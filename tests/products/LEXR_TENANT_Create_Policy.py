    ...
    def test_login_search_for_agent_create_quote(self, browser, env):
        ...
        for x in range(1, sh.nrows):
            ...
            if empty_cell == False:
                ...
                number_locations = str(round(sh.cell_value(i, 7)))
                number_residential_units = str(round(sh.cell_value(i, 8)))
                retail_sq_ft = str(round(sh.cell_value(i, 9)))
                office_sq_ft = str(round(sh.cell_value(i, 10)))
                industrial_sq_ft = str(round(sh.cell_value(i, 11)))
            ...
            saw_ii.create_quote_01(number_locations, number_residential_units, retail_sq_ft, office_sq_ft, industrial_sq_ft)
            ...
            if test_scenario_number == "1":
                saw_PAF.create_quote_Corporation_Property_Management_Company(number_years_in_business, company_name_string)
                ...
                saw_PAF.create_quote_Other_Property_Management_Property_Owner(number_years_in_business, company_name_string)
