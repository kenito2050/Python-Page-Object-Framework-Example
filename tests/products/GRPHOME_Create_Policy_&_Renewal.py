...
from pages.producer_center.saw.products.GRPHOME.insured_information.insured_information import Insured_Information
from pages.producer_center.saw.products.GRPHOME.PAF.PAF import PAF
from pages.producer_center.saw.products.GRPHOME.coverage_options.HNOA_coverage_options import HNOA_Coverage_Options
from pages.producer_center.saw.products.GRPHOME.coverage_options.No_HNOA_coverage_options import No_HNOA_Coverage_Options
from pages.producer_center.saw.products.GRPHOME.coverage_options.coverage_options import Coverage_Options
from pages.producer_center.saw.products.GRPHOME.select_option.select_option import Select_Option
...
class CreateQuote():
    ...
    def test_login_search_for_agent_create_quote(self):
        ...
        if test_scenario == "1":
            saw_PAF.create_quote_include_HNOA(years_in_business, staff_count)
            saw_PAF.input_retroactive_date(retroactive_date)
        elif test_scenario == "2":
            saw_PAF.create_quote_NO_HNOA(years_in_business, staff_count)
            saw_PAF.input_retroactive_date(retroactive_date)
