...
from pages.producer_center.saw.products.Transitional_Living_Facilities.insured_information.insured_information import Insured_Information
from pages.producer_center.saw.products.Transitional_Living_Facilities.PAF.PAF import PAF
from pages.producer_center.saw.products.Transitional_Living_Facilities.coverage_options.HNOA_coverage_options import HNOA_Coverage_Options
from pages.producer_center.saw.products.Transitional_Living_Facilities.coverage_options.No_HNOA_coverage_options import No_HNOA_Coverage_Options
from pages.producer_center.saw.products.Transitional_Living_Facilities.coverage_options.coverage_options import Coverage_Options
from pages.producer_center.saw.products.Transitional_Living_Facilities.select_option.select_option import Select_Option
...
class TestCreateQuote:
    ...
    def test_login_search_for_agent_create_quote(self, browser, env):
        ...
        Product = "Transitional_Living_Facilities"
        driver = browser
        ...
        for x in range(1, sh.nrows):
            ...
            if empty_cell == False:
                ...
                contract_class = sh.cell_value(i, 5)
                city = sh.cell_value(i, 6)
                state = sh.cell_value(i, 7)
                zip = str(round(sh.cell_value(i, 8)))
                total_occupied_beds = str(round(sh.cell_value(i, 9)))
                years_in_business = str(round(sh.cell_value(i, 10)))
        ...
        pp.click_Transitional_Living_Facilities()
        ...
        saw_ii.enter_number_occupied_beds(total_occupied_beds)
        saw_ii.click_next()
