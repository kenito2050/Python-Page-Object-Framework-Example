...
from pages.producer_center.saw.products.CYB_PAS.PAF.PAF import PAF
from pages.producer_center.saw.products.CYB_PAS.coverage_options.PCI_Options.PCI_coverage_options import PCI_Coverage_Options
from pages.producer_center.saw.products.CYB_PAS.coverage_options.No_PCI_Options.No_PCI_coverage_options import No_PCI_Coverage_Options
from pages.producer_center.saw.products.CYB_PAS.coverage_options.coverage_options import Coverage_Options
from pages.producer_center.saw.products.CYB_PAS.insured_information.insured_information import Insured_Information
from pages.producer_center.saw.products.CYB_PAS.select_option.select_option import Select_Option
...
class TestCreateQuote():
    ...
    def test_login_search_for_agent_create_quote(self, browser, env):
        ...
        for x in range(1, sh.nrows):
            ...
            # 1 - Medical Group, Office of Physician, Chiropractors or Podiatry with PCI option
            # 2 - Medical Group, Office of Physician, Chiropractors or Podiatry, NO PCI option
