...
from pages.producer_center.saw.products.CYB_CAP.coverage_options.Jan_01_2018.PCI_coverage_options import PCI_Coverage_Options
from pages.producer_center.saw.products.CYB_CAP.coverage_options.Jan_01_2018.No_PCI_coverage_options import No_PCI_Coverage_Options
from pages.producer_center.saw.products.CYB_CAP.coverage_options.Jan_01_2018.coverage_options import Coverage_Options
...
class CreateQuote(unittest.TestCase):
    ...
    def test_login_search_for_agent_create_quote(self):
        ...
        # saw_CC_No_PCI.select_Medefense_Plus_and_CyberRisk_Combined_Separate_Limits_with_Cyber_Crime_No_PCI()
        # saw_CC_No_PCI.select_Medefense_Plus_and_CyberRisk_Combined_Separate_Limits_with_Claim_Expenses_Outside_Limits_and_Cyber_Crime_No_PCI()
        # saw_CC_No_PCI.select_Medefense_Plus_with_Review_Proceeding_Sublimit_and_CyberRisk_Combined_Shared_Limits_with_Cyber_Crime_No_PCI()
        # saw_CC_No_PCI.select_Medefense_Plus_with_Peer_Review_Proceeding_Sublimit_and_CyberRisk_Combined_Shared_Limits_with_Claim_Expenses_Outside_Limits_and_Cyber_Crime_No_PCI()
        # saw_CC_No_PCI.select_Medefense_Plus_with_Peer_Review_Proceeding_Sublimit_and_CyberRisk_Combined_Shared_Limits_with_Cyber_Crime_No_PCI()
        # saw_CC_No_PCI.select_Medefense_Plus_with_Peer_Review_Proceeding_Sublimit_and_CyberRisk_Combined_Separate_Limits_with_Claim_Expenses_Outside_Limits_and_Cyber_Crime_No_PCI()
