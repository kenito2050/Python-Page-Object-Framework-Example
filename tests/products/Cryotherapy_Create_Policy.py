...
from pages.producer_center.saw.products.CRYO.insured_information.insured_information import Insured_Information
from pages.producer_center.saw.products.CRYO.PAF.PAF import PAF
from pages.producer_center.saw.products.CRYO.coverage_options.coverage_options import Coverage_Options
from pages.producer_center.saw.products.CRYO.select_option.select_option import Select_Option
...
class TestCreateQuote:
    ...
    def test_login_search_for_agent_create_quote(self, browser, env):
        ...
        if test_scenario == "1":
            saw_PAF.create_quote_include_No_SMML_Sell_Products_Yes(years_in_business, staff_count, revenue_current_year)
        elif test_scenario == "2":
            saw_PAF.create_quote_include_No_SMML_Sell_Products_Yes(years_in_business, staff_count, revenue_current_year)
        elif test_scenario == "3":
            saw_PAF.create_quote_include_SMML_Sell_Products_Yes(years_in_business, staff_count, revenue_current_year)
