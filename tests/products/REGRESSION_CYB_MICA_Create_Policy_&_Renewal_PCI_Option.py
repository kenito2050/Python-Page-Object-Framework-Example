...
from pages.producer_center.saw.insured_information_Generic import Insured_Information_Generic
from pages.producer_center.saw.PAF_Generic import PAF_Generic
...
class CreateQuote(unittest.TestCase):
    ...
    def login_search_for_agent_create_quote(self):
        ...
        # Declare generic instance of Insured Information screen
        saw_generic_ii = Insured_Information_Generic(driver)

        # Declare product specific instance of Insured Information screen
        saw_ii = Insured_Information(driver)

        # enter physician count
        saw_ii.enter_physician_count(doctor_count)

        # Click Next (Using generic instance of Insured Information screen)
        saw_generic_ii.click_next()

        # Declare generic instance of PAF screen
        ...
        ##############################################################
        ##############################################################
        ## This Section updates the Creation Date
        ## Return to Admin; Locate Application just created; update the creation date

        # Return to Admin Interface / Set Creation Date (Using generic instance of PAF screen)
        saw_PAF_Generic.click_return_to_Admin_Interface()
        ...
        app_details.update_create_date(ad_hoc_Date)
        ...
        # PAF Should Display but Different Forms should display
        #TODO: Open PDF links and validate that correct forms display

        # Return to PAF and Click Next

        # Click Next on PAF Screen (Using generic instance of PAF screen)
        saw_PAF.click_next()
