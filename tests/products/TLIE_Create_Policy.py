...
from pages.producer_center.saw.products.TLIE.PAF.PAF import PAF

### PCI Coverage Options Classes
from pages.producer_center.saw.products.TLIE.coverage_options.PCI_Options.PCI_coverage_options import PCI_Coverage_Options

### Non PCI Coverage Options Classes
from pages.producer_center.saw.products.TLIE.coverage_options.No_PCI_Options.No_PCI_coverage_options import No_PCI_Coverage_Options

from pages.producer_center.saw.products.TLIE.coverage_options.coverage_options import Coverage_Options
from pages.producer_center.saw.products.TLIE.insured_information.insured_information import Insured_Information
from pages.producer_center.saw.products.TLIE.select_option.select_option import Select_Option
...
class TestCreateQuote():
    ...
    def test_login_search_for_agent_create_quote(self, browser, env):
        ...
        for x in range(1, sh.nrows):
            ...
            if test_scenario == "1":
                saw_PAF.create_quote_PCI_DSS_No_DQ(revenue, staff_count)
            elif test_scenario == "2":
                saw_PAF.create_quote_No_PCI_DSS_No_DQ(revenue, staff_count)
