...
class TestCreateQuote:
    ...
    def test_login_search_for_agent_create_quote(self, browser, env):
        ...
        for i in range(1, sh.nrows):
            ...
            if test_scenario == "1":
                saw_PAF.create_quote_No_Product_Liability(years_in_business, staff_count, number_procedures,
                                                          revenue_last_year, revenue_upcoming_year,
                                                          effective_date_formatted)
            elif test_scenario == "2":
                saw_PAF.create_quote_Product_Liability(years_in_business, staff_count, number_procedures,
                                                       revenue_last_year, revenue_upcoming_year,
                                                       effective_date_formatted)
