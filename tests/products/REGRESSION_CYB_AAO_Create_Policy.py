...
class TestCreateQuote:
    ...
    def test_login_search_for_agent_create_quote(self, browser, env):
        ...
        for i in range(1, sh.nrows):
            ...
            # download_dir = (str(test_results_directory / 'Regressions' / Product + '_Regression_Test_Results.csv'))
            #
            ...
            #
            # # Declare Directory of csv file
            # download_dir = (str(test_results_directory / 'Regressions' / Product + '_Regression_Test_Results.csv'))  # where you want the file to be downloaded to
            #
