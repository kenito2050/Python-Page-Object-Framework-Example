...
class CreateAccount():
    ...
    def create_account_quote(self):
        ...
        test_run_type = (test_environment[2][0].text)
        ...
        for x in range(1, sh.nrows):
            ...
            if test_scenario == "1" or test_scenario == "3" or test_scenario == "4":
                ...
                download_dir = os.path.join(test_results_directory, 'Regressions',
                                            Product + '_Regression_Test_Results.csv')
                ...
                scenario_2_values = [test_summary, company_name_excel, city, formatted_postal_code, preferred_wholesaler, registration_code]
            ...
            # Declare the values that will be outputted to csv
            values = [test_summary, company_name_faker, city, formatted_postal_code, preferred_wholesaler, registration_code]
            ...
            with open(download_dir, "w") as f:
                ...
                writer = csv.writer(f)
                writer.writerow({'Test Summary' : test_summary, 'Company_Name' : company_name_faker })
